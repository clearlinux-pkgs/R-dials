...
Version  : 1.4.0
Release  : 10
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/dials_1.4.0.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/dials_1.4.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740091086
...
/usr/lib64/R/library/dials/tests/testthat/_snaps/aaa_ranges.md
