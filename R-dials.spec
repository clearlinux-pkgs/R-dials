...
Version  : 1.2.1
Release  : 6
URL      : https://cran.r-project.org/src/contrib/dials_1.2.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/dials_1.2.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708618354
